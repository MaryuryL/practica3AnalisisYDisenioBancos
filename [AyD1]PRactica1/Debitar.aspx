<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Debitar.aspx.cs" Inherits="_AyD1_PRactica1.Debitar" %>
    ...
    <form id="form1" runat="server">
        <div class="login-wrap">
            <div class="login-html">
                <input id="tab-1" type="radio" name="tab" class="sign-in" checked /><label for="tab-1" class="tab">Debitar</label>                
