<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="credito.aspx.cs" Inherits="_AyD1_PRactica1.credito" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="login-wrap">
            <div class="login-html">
                <input id="tab-1" type="radio" name="tab" class="sign-in" checked /><label for="tab-1" class="tab">Acreditar</label>                
                ...
                <div class="login-form">
                    <div class="sign-in-htm">
                        ...
                        <div class="group">
                            <label for="TextBox3" class="label">Descripcion</label>
                            <asp:TextBox ID="TextBox3" runat="server" class="input" TextMode="MultiLine"></asp:TextBox>
                        </div>                   
                        <div class="group">
                            <asp:Button ID="Button1" runat="server" Text="Hecho" class="button" OnClick="Button1_Click" />
